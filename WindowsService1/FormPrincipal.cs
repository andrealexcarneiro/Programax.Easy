...
namespace Programax.Easy.View.Telas
{
    public partial class FormPrincipal : Form
    {
        ...
        {
            FormVendaRapida formVendaRapida = new FormVendaRapida();
        ...
        public void VerificarAtualizacao()
        {
            try
            {
                ...
                if (DataHoraArquivoDir.AddDays(2) < fileDateTime)
                {
                    ...
                    {
                        FormAtualizacaoSistema formAtualizacao = new FormAtualizacaoSistema();
        ...
        private void CarregueInformacoesUsuario()
        {
            ...
            lblVersaoSistema.Text = informacaoSistema.Versao + " / 1.1.17.1";
        }
