...
{
    public partial class RelatorioPedidoVendaDuasViasAgenda : RelatorioBaseDev
    {
        ...
        public RelatorioPedidoVendaDuasViasAgenda(int numeroPedido, EnumTipoEndereco? tipoEndereco=null)
        {
            InitializeComponent();
