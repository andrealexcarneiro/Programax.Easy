...
{
    public partial class RelatorioContratoVenda : RelatorioBaseDev
    {
        ...
        public RelatorioContratoVenda(int numeroPedido, Parametros paramentros)
        {
            InitializeComponent();
            
            _numeroPedido = numeroPedido;
            _parametros = paramentros;

            _tituloRelatorio = _parametros.ParametrosVenda.NomeContrato;
        }
        ...
        protected override void CarregueDadosRelatorio()
        {
            ...
            pedidoDeVendaRelatorio.DataMontagem = pedido.DataMontagem != null ? pedido.DataMontagem.Value.ToString("dd/MM/yyyy") : string.Empty;
            pedidoDeVendaRelatorio.DataDesmontagem = pedido.DataDesmontagem != null ? pedido.DataDesmontagem.Value.ToString("dd/MM/yyyy") : string.Empty;
            ...
            lblTermos.Text = _parametros.ParametrosVenda.TermosContrato;
            lblEmpresaAssinatura.Text = lblNomeEmpresa.Text;
        ...
        public class PedidoDeVendaRelatorio
        {
            ...
            public string DataDesmontagem { get; set; }
