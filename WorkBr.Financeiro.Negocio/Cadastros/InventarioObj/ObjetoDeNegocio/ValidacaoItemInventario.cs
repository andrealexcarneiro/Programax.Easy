...
{
    public class ValidacaoItemInventario: ValidacaoBase<ItemInventario>
    {
        #region " PROPRIEDADES "

        public SubEstoque SubEstoque { get; set; }
        ...
        private void AssineRegraItemJaEstahEmInventario()
        {
            ...
            //RuleFor(itemInventario => itemInventario.Produto)
            //    .Must(produto =>{
            ...
            //    })
            //    .WithMessage(mensagemComposta)
            //    .When(itemInventario => Inventario.Id == 0);
        }
