...
{
    public partial class FormEntradaMercadoriaManual : FormularioPadrao
    {
        ...
        public FormEntradaMercadoriaManual()
        {
            InitializeComponent();

            this.NomeDaTela = "Entrada de Mercadorias Manual";
        ...
        private void txtNumeroNfe_Leave(object sender, EventArgs e)
        {
            if (_idEntradaMercadoria == 0)
            {
                ...
                if (txtNumeroNfe.Text != string.Empty)
                {
                    ...
                    var entrada = servicoEntradaMercadoria.ConsulteListaNumero(txtNumeroNfe.Text, 1);
                    ...
                    {
                        FormPesquisaDeEntradaDeMercadorias formPesquisaDeEntrada = new FormPesquisaDeEntradaDeMercadorias(1);

                        var entradaMercadoria = formPesquisaDeEntrada.ExibaPesquisaDeEntradas(1);
        ...
        private void btnPesquisaEntrada_Click(object sender, EventArgs e)
        {
            ...
            var entrada = formPesquisaDeEntrada.ExibaPesquisaDeEntradas(1);
        ...
        private EntradaMercadoria RetorneEntradaMercadoriaEmEdicao()
        {
            ...
            entradaMercadoria.ModeloDocumentoFiscal = (EnumModeloDocumentoFiscal)1.ToInt();

            entradaMercadoria.TipoFrete = EnumTipoFrete.SEMCOBRANCADEFRETE;
            entradaMercadoria.NaturezaOperacaoNota = "ENTRADA MANUAL";
        ...
        private void PreenchaCamposDoProduto(Produto produto)
        {
            ...
            if (produto != null)
            {
                ...
                cboUnidade.EditValue = produto.DadosGerais.Unidade.Id;
                cboOrigem.EditValue = produto.ContabilFiscal.OrigemProduto;
               // cboCstCsosn.EditValue = produto.ContabilFiscal.GrupoTributacaoIcms.ListaTributacoesIcms[0].CstCsosn;
                cboCfop.EditValue = entrada;
                txtValorUnitario.Text = produto.FormacaoPreco.PrecoCompra.ToString();
                txtPercentualDesconto.Text = "0,00";
        ...
        private void txtQuantidadeEstocar_EditValueChanged(object sender, EventArgs e)
        {

        }
        private void txtQuantidadeEstocar_Leave(object sender, EventArgs e)
        {
            txtQuantidade.Text = txtQuantidadeEstocar.Text;
