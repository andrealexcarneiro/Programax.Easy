...
{
    public partial class FormPesquisaProdutoT : FormularioPadrao
    {
        ...
        private void PreencherGrid()
        {
            ...
            foreach (var produto in _listaDeProdutos)
            {
                ...
                {
                    produtoAuxiliar.Disponivel = (produto.FormacaoPreco.Estoque - produto.FormacaoPreco.EstoqueReservado).ToString();
                }
