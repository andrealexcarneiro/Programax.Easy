...
{
    public partial class FormCadastroPessoa : FormularioPadrao
    {
        ...
        public FormCadastroPessoa(int CodCliente = 0) //CodCliente - Acrescentar
        {
            InitializeComponent();
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  LimpeCampos();
                ...
                var pessoaconsulta = _servicoPessoa.Consulte(pessoa.Id);
        ...
        private void PreenchaDadosGerais(DadosGerais dadosGerais)
        {
            ...
            if (dadosGerais.CpfCnpj != null)
            {
                if (dadosGerais.CpfCnpj.Length.ToInt() == 14)
                {
                    cboTipoPessoa.EditValue = EnumTipoPessoa.PESSOAFISICA;
                }
                else
                {
                    cboTipoPessoa.EditValue = EnumTipoPessoa.PESSOAJURIDICA;
                }
            }
            ...
            {
                picFoto.Image = Properties.Resources.icone_azul;
            }
            else
            {
