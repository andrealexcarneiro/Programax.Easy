...
{
    public partial class FormPesquisaCategoriasFinanceiras : FormularioPadrao
    {
        #region " VARIÁVEIS PRIVADAS "

        private CategoriaFinanceira _categoriaSelecionada;
        ...
        public FormPesquisaCategoriasFinanceiras()
        {
            InitializeComponent();
        ...
        public CategoriaFinanceira PesquiseUmaCategoria()
        {
            this.ShowDialog();
