    ...
    public partial class FormCadastroCategoriasFinanceiras : FormularioPadrao
    {
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            Action actionSalvar = () =>
            {
                ...
                categoria.Mostrar = chkMostrar.Checked;
                categoria.MostrarDRE = chkMostrarDre.Checked;
        ...
        private void EditeCategoria(CategoriaFinanceira categoria)
        {
            if (categoria != null)
            {
                ...
                chkMostrar.Checked = categoria.Mostrar;
                chkMostrarDre.Checked = categoria.MostrarDRE;
