...
{
    public partial class FormGruposCategoriasPesquisa : FormularioPadrao
    {
        #region " VARIÁVEIS PRIVADAS "

        private List<GrupoCategoria> _listaDeGrupos;
        private GrupoCategoria _GrupoSelecionado;

        #endregion

        #region " CONSTRUTOR "

        public FormGruposCategoriasPesquisa()
        {
            InitializeComponent();
        ...
        public GrupoCategoria ExibaPesquisaDeGrupo()
        {
            this.ShowDialog();
