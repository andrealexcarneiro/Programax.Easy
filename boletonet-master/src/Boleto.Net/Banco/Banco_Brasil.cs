    ...
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        ...
        public override string GerarDetalheSegmentoPRemessa(Boleto boleto, int numeroRegistro, string numeroConvenio)
        {
            try
            {
                ...
                _segmentoP = "001"+ Utils.FormatCode(boleto.Remessa.NumeroLote.ToString(), "0", 4, true) + "3";
        ...
        public override string GerarDetalheSegmentoQRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _segmentoQ = "001"+ Utils.FormatCode(boleto.Remessa.NumeroLote.ToString(), "0", 4, true) + "3";
        ...
        public override string GerarDetalheSegmentoRRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _segmentoR = "001" + Utils.FormatCode(boleto.Remessa.NumeroLote.ToString(), "0", 4, true) + "3";
        ...
        public override string GerarTrailerLoteRemessa(int numeroRegistro, int numeroLote=1)
        {
            try
            {
                ...
                trailer += Utils.FitStringLength(numeroLote.ToString(), 4, 4, '0', 0, true, true, true);
                trailer += "5";
        ...
        private string GerarHeaderLoteRemessaCNAB240(string numeroConvenio, Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                ...
                _headerLote = "001"+ Utils.FormatCode(numeroArquivoRemessa.ToString(), "0", 4, true) +"1R01  "; //posições 12-13 são espaços e não zeros
                ...
                {
                    _headerLote += cedente.Carteira.ToString();
                    _headerLote += cedente.Variacao != string.Empty ? cedente.Variacao + "  " : "019  ";
                }
                else
        ...
        public string GerarHeaderRemessaCNAB240(Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                ...
                if (cedente.Carteira.Length == 2)
                {
                    _header += cedente.Carteira.ToString();
                    _header += cedente.Variacao != string.Empty ? cedente.Variacao : "019";
                }
                else
